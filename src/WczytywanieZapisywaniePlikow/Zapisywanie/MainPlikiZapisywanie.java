package WczytywanieZapisywaniePlikow.Zapisywanie;
...
public class MainPlikiZapisywanie {
    public static void main(String[] args) {
        ...
        try {
            String path = "D:\\Z_WOJCIECH\\KURSY\\JAVA\\JetBrainsProjects\\src\\WczytywanieZapisywaniePlikow\\Zapisywanie\\plik_zapis.txt";
