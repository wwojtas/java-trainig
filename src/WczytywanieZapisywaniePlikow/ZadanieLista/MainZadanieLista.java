package WczytywanieZapisywaniePlikow.ZadanieLista;
...
public class MainZadanieLista {
    public static void main(String[] args) {
        ...
        try {
            // odczytujemy z pliku
            String path = "D:\\Z_WOJCIECH\\KURSY\\JAVA\\JetBrainsProjects\\src\\WczytywanieZapisywaniePlikow\\ZadanieLista\\fragment.txt";
            File file = new File(path);
            FileReader fileReader = new FileReader(file);
            BufferedReader bufferedReader = new BufferedReader(fileReader);

            // zapisujemy do pliku
            String pathWrite = "D:\\Z_WOJCIECH\\KURSY\\JAVA\\JetBrainsProjects\\src\\WczytywanieZapisywaniePlikow\\ZadanieLista\\fragment-kopia.txt";
